...
public final class GameModeModule implements PluginModule {
    ...
    public void disable() {
        ...
        unregisterCommand("gamemode", formatter);
        unregisterCommand("gmc", formatter);
        unregisterCommand("gms", formatter);
        unregisterCommand("gmsp", formatter);
        unregisterCommand("gma", formatter);
        this.context.serviceRegistry().unregister(GameModeService.class);
    }
